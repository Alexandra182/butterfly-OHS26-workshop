...
Same flap motion where each LED's color is fixed
...
pixels = neopixel.NeoPixel(board.GP2, NUM_PIXELS, brightness=0.5, auto_write=False)

# Tunables
INNER_COLOR = (255, 0, 155)    # soft purple near the body
OUTER_COLOR = (25, 0, 100)       # deep purple at the wingtip
